...
var randomize = function(thisThat) {
	return thisThat[Math.floor(Math.random() * thisThat.length)];
}

var answer = function (first, second) {	
	return "So, basically, it's like a " + randomize(first) + " for " + randomize(second) + "!";
}

console.log(answer(_this, _that));
console.log(answer(_this, _that));
console.log(answer(_this, _that));